  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-4xl mx-auto bg-card p-8 rounded-3xl border border-border shadow-sm mb-16">
        <img src={pet.image} className="w-full h-96 object-cover rounded-2xl mb-6" />
        <h1 className="text-4xl font-bold mb-4">{`Help ${pet.petName} Get Surgery`}</h1>
        <p className="text-muted-foreground mb-8 text-lg">{pet.longDescription}</p>
